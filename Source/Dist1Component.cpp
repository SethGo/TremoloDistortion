...
//==============================================================================
Dist1Component::Dist1Component(TremDistortionAudioProcessor& p)
: audioProcessor (p)
{
    // Control knobs
    ...
    gainSliderAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.apvts, "GAIN1", gainSlider);
    ...
    toneSliderAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.apvts, "TONE1", toneSlider);
    ...
    volSliderAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(audioProcessor.apvts, "VOL1", volSlider);
...
void Dist1Component::paint (juce::Graphics& g)
{
